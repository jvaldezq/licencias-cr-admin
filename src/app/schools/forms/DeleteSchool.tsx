...
import {useDeleteMutation} from "@/app/schools/services/client";

export const DeleteSchool = ({id}: { id: string }) => {
    ...
    return (<Dialog
        ...
        isLoading={isLoading}
        loadingContent={<FormSavingLoader message="Eliminando Escuela"/>}
        footer={<Button
            onClick={onDelete}
        ...
        {isLoading ? null :
            <p className="text-primary text-base font-medium">Está seguro que desea eliminar la Escuela</p>}
    </Dialog>)
}